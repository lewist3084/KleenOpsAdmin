// lib/features/engagement/screens/internal_reports.dart
...
class InternalReportsContent extends ConsumerStatefulWidget {
  const InternalReportsContent({super.key});

  @override
  ConsumerState<InternalReportsContent> createState() => _InternalReportsContentState();
}

class _InternalReportsContentState extends ConsumerState<InternalReportsContent> {
