...
/// Hub for the Supervision feature.
  ...
  Widget build(BuildContext context) {
    Widget buildBottomBar({MenuDrawerSections? menuSections}) {
      return Column(
        ...
        children: [
          DetailsAppBar(title: 'Supervision', menuSections: menuSections),
    ...
    return Scaffold(
      ...
      body: _wrapCanvas(const SupervisionHomeContent()),
          ...
          final menuSections = MenuDrawerSections(
            actions: [
              ContentMenuItem(
                ...
                label: 'Stats',
                onTap: () => context.push(AppRoutePaths.supervisionStats),
              ),
            ],
          );
...
class SupervisionHomeContent extends StatelessWidget {
  const SupervisionHomeContent({super.key});
