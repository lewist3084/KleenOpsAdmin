...
class PurchasingStatsScreen extends StatelessWidget {
  const PurchasingStatsScreen({super.key});
...
class PurchasingStatsContent extends StatelessWidget {
  const PurchasingStatsContent({super.key});
