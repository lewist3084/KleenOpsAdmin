...
class QualityStatsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: AiScreenContext(
        context: AiContextPresets.qualityStats(),
        child: _wrapCanvas(
          const QualityStatsContent(),
        ),
      ),
...
class QualityStatsContent extends StatelessWidget {
  const QualityStatsContent({super.key});
