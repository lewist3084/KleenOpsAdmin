  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final menuConfigs = <MenuButtonConfig>[
      ...
      MenuButtonConfig(
        ...
        onPressed: (ctx) => ctx.go(AppRoutePaths.financeHome),
      ),
      MenuButtonConfig(
        id: 'hr',
        label: 'HR',
        ...
        accessFlagKey: 'hr',
        onPressed: (ctx) => ctx.go(AppRoutePaths.hrHome),
      ),
      MenuButtonConfig(
        id: 'administration',
        label: 'Admin',
        ...
        onPressed: (ctx) => ctx.go(AppRoutePaths.adminHome),
      ),
      MenuButtonConfig(
        id: 'sales',
        label: 'Sales',
        ...
        accessFlagKey: 'sales',
        onPressed: (ctx) => ctx.go(AppRoutePaths.salesHome),
      ),
      MenuButtonConfig(
        id: 'purchasing',
        label: 'Purchasing',
        ...
        onPressed: (ctx) => ctx.go(AppRoutePaths.purchasingHome),
      ),
      MenuButtonConfig(
        id: 'aiUsage',
        label: 'AI Usage',
