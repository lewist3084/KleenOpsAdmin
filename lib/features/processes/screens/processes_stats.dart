...
class ProcessesStatsScreen extends StatelessWidget {
  const ProcessesStatsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.grey[100],
      body: const ProcessesStatsContent(),
      bottomNavigationBar: const HomeNavBarAdapter(),
    );
  }
}

class ProcessesStatsContent extends StatelessWidget {
  const ProcessesStatsContent({super.key});
