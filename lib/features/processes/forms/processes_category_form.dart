...
class ProcessesCategoryForm extends StatefulWidget {
  const ProcessesCategoryForm({
    super.key,
  ...
  @override
  State<ProcessesCategoryForm> createState() => _ProcessesCategoryFormState();
}

class _ProcessesCategoryFormState extends State<ProcessesCategoryForm> {
  ...
  Future<void> _loadExisting() async {
    ...
    try {
      final docRef =
          widget.companyRef.collection('processCategory').doc(widget.docId);
  ...
  Future<void> _handleSave() async {
    ...
    try {
      await _firestore.saveDocument(
        collectionRef: widget.companyRef.collection('processCategory'),
        docId: widget.docId,
        data: data,
      );
      if (mounted) {
